...
private val CURATED = listOf(
    StudioTemplate("Green Dome", listOf(Color(0xFF0A1A12)), Color.White, Color(0xFFF2C14E), imageUrl = ImageStore.resolve("green_dome"), card = Color.Black.copy(alpha = 0.38f), blur = 12f, overlay = 0.35f),
    StudioTemplate("Night Peaks", listOf(Color(0xFF0B0E14)), Color.White, Color(0xFFC9B8FF), imageUrl = ImageStore.resolve("blue_night"), card = Color(0xFF1A1636).copy(alpha = 0.6f), blur = 20f, overlay = 0.45f, vignette = 0.30f),
    StudioTemplate("Golden Hour", listOf(Color(0xFF2A1A0E)), Color.White, Color(0xFFFFD98A), imageUrl = ImageStore.resolve("amber"), card = Color.Transparent, overlay = 0.45f), // sharp, no card, strong scrim
    StudioTemplate("Serene", listOf(Color(0xFF10161C)), Color.White, Color(0xFFA9E5D6), imageUrl = ImageStore.resolve("sage"), card = Color.Black.copy(alpha = 0.40f), blur = 16f, overlay = 0.40f),
    StudioTemplate("Sanctuary", listOf(Color(0xFF14110A)), Color.White, Color(0xFFF2C14E), imageUrl = ImageStore.resolve("gold_light"), card = Color(0xFF241A10).copy(alpha = 0.62f), overlay = 0.42f), // sharp, brown plate
    StudioTemplate("Midnight", listOf(Color(0xFF0E1116)), Color.White, Color(0xFFFBC02D), card = Color(0xFF101318)), // solid ink card
    StudioTemplate("Emerald", listOf(Color(0xFF0E4D3A), Color(0xFF06251C)), Color.White, Color(0xFFF2C14E), card = Color.Black.copy(alpha = 0.28f), vignette = 0.30f),
