        ...
        modifier = modifier
            ...
            .pointerInput(isEditing, config.bgImageUrl != null) {
                ...
                detectTransformGestures { _, pan, zoom, _ ->
                    ...
                    if (r == null) {
                        onUpdate(c.copy(bgImageScale = newScale, bgImageOffsetX = c.bgImageOffsetX + pan.x, bgImageOffsetY = c.bgImageOffsetY + pan.y))
            ...
            Box(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    if (config.showHijri || config.showGregorian) {
                        ...
                        val hijri = if (config.showHijri) "${todayHijri.day} ${HijriMonth.of(todayHijri.month).label()} ${todayHijri.year} ${stringResource(Res.string.hijri_era)}" else ""
