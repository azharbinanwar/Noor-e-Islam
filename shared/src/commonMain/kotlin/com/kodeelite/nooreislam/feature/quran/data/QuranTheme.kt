...
enum class QuranTheme(
    ...
    val surfaceContainerHigh: Color,  // bottom sheet / raised surface, distinct from tiles
    ...
    System(
        ...
        background = Color(0xFFFBF8F1), surface = Color(0xFFFFFFFF), surfaceContainer = Color(0xFFF2ECDF), surfaceContainerHigh = Color(0xFFECE6D9),
    ...
    Paper(
        ...
        background = Color(0xFFF3ECDD), surface = Color(0xFFF9F3E7), surfaceContainer = Color(0xFFEBE2CE), surfaceContainerHigh = Color(0xFFE5DCC9),
    ...
    WarmGray(
        ...
        background = Color(0xFFECEAE5), surface = Color(0xFFF4F2EE), surfaceContainer = Color(0xFFE0DDD6), surfaceContainerHigh = Color(0xFFDAD7D1),
    ...
    Amber(
        ...
        background = Color(0xFFFBEBCB), surface = Color(0xFFFDF3DD), surfaceContainer = Color(0xFFF4E1BC), surfaceContainerHigh = Color(0xFFEEDBB7),
    ...
    Sepia(
        ...
        background = Color(0xFFF1E4C9), surface = Color(0xFFF7EEDA), surfaceContainer = Color(0xFFEADCBB), surfaceContainerHigh = Color(0xFFE4D6B6),
    ...
    DustyBlue(
        ...
        background = Color(0xFFE7ECF1), surface = Color(0xFFF1F4F8), surfaceContainer = Color(0xFFD9E1EA), surfaceContainerHigh = Color(0xFFD4DBE4),
    ...
    Green(
        ...
        background = Color(0xFFE7F1E9), surface = Color(0xFFF1F7F2), surfaceContainer = Color(0xFFD9E9DC), surfaceContainerHigh = Color(0xFFD4E3D6),
    ...
    Mint(
        ...
        background = Color(0xFFE9F0EE), surface = Color(0xFFF2F7F5), surfaceContainer = Color(0xFFDBE7E3), surfaceContainerHigh = Color(0xFFD6E1DD),
    ...
    Dark(
        ...
        background = Color(0xFF171612), surface = Color(0xFF201E17), surfaceContainer = Color(0xFF272419), surfaceContainerHigh = Color(0xFF312E23),
    ...
    DimGray(
        ...
        background = Color(0xFF1A1A19), surface = Color(0xFF242422), surfaceContainer = Color(0xFF2C2C2A), surfaceContainerHigh = Color(0xFF353534),
    ...
    Charcoal(
        ...
        background = Color(0xFF201F1D), surface = Color(0xFF2A2825), surfaceContainer = Color(0xFF33302B), surfaceContainerHigh = Color(0xFF3C3935),
    ...
    Slate(
        ...
        background = Color(0xFF14181D), surface = Color(0xFF1C2127), surfaceContainer = Color(0xFF232A31), surfaceContainerHigh = Color(0xFF2D343A),
    ...
    Night(
        ...
        background = Color(0xFF0A0A0B), surface = Color(0xFF141416), surfaceContainer = Color(0xFF1B1B1E), surfaceContainerHigh = Color(0xFF252528),
...
fun QuranTheme.applyTo(base: AppColors): AppColors =
    if (this == QuranTheme.System) base
        ...
        surfaceContainer = surfaceContainer, surfaceContainerHigh = surfaceContainerHigh, surfaceContainerHighest = surfaceContainer,
